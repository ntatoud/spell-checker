...
\begin{procedure}
    ...
    \Deb{
        ...
        \Pour{i $\gets$ 1 à longueur}{
            ...
            \tantQue{ EnsembleDeMot.cardinalité(correctionsCourantes) \neq 0}{
...
\begin{procedure}
    ...
    \Deb{
        ...
        longueur $\gets$ Mot.longueur(leMotACorriger)\;
        desCorrections $\gets$ EnsembleDeMot.ensembleDeMot()\;
        \Pour{i $\gets$ 2 à longueur-1)}{
            unMotModifiable = Mot.copierMot(leMotACorriger)\;
            uneCorrection $\gets$ M_decomposerMot(unMotModifiable,i)\;
            \si {Dictionnaire.estUnMotDuDictionnaire(leDico,Mot.copierMot(uneCorrection)) et Dictionnaire.estUnMotDuDictionnaire(leDico,M_copierMot(unMotModifiable))}{
                EnsembleDeMot.ajouter(desCorrections,uneCorrection)\;
